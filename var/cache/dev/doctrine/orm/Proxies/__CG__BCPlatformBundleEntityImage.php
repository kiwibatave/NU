...
namespace Proxies\__CG__\BC\PlatformBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \BC\PlatformBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BC\\PlatformBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'BC\\PlatformBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'BC\\PlatformBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'BC\\PlatformBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'BC\\PlatformBundle\\Entity\\Image' . "\0" . 'temporaryFilename'];
        }

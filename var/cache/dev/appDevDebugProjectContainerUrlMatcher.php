    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/platform')) {
            ...
            if (preg_match('#^/platform(?:/(?P<page>\\d*))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'bc_platform_home')), array (  '_controller' => 'BC\\PlatformBundle\\Controller\\AdvertController::indexAction',  'page' => 1,));
            }

            // bc_platform_view
            if (0 === strpos($pathinfo, '/platform/advert') && preg_match('#^/platform/advert/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'bc_platform_view')), array (  '_controller' => 'BC\\PlatformBundle\\Controller\\AdvertController::viewAction',));
            }

            // bc_platform_add
            if ('/platform/add' === $pathinfo) {
                return array (  '_controller' => 'BC\\PlatformBundle\\Controller\\AdvertController::addAction',  '_route' => 'bc_platform_add',);
            }

            // bc_platform_edit
            if (0 === strpos($pathinfo, '/platform/edit') && preg_match('#^/platform/edit/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'bc_platform_edit')), array (  '_controller' => 'BC\\PlatformBundle\\Controller\\AdvertController::editAction',));
            }

            // bc_platform_delete
            if (0 === strpos($pathinfo, '/platform/delete') && preg_match('#^/platform/delete/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'bc_platform_delete')), array (  '_controller' => 'BC\\PlatformBundle\\Controller\\AdvertController::deleteAction',));
            }
        ...
        if ('' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($rawPathinfo.'/', 'bc_core_homepage');
            }

            return array (  '_controller' => 'BC\\CoreBundle\\Controller\\CoreController::indexAction',  '_route' => 'bc_core_homepage',);
        }

        // bc_core_contact
        if ('/contact' === $pathinfo) {
            return array (  '_controller' => 'BC\\CoreBundle\\Controller\\CoreController::contactAction',  '_route' => 'bc_core_contact',);
        }
        ...
        if (0 === strpos($pathinfo, '/traduction') && preg_match('#^/traduction/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'bc_platform_translation')), array (  '_controller' => 'BC\\PlatformBundle\\Controller\\AdvertController::translationAction',));
        }

        // bc_platform_paramconverter
        if (0 === strpos($pathinfo, '/test') && preg_match('#^/test/(?P<json>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'bc_platform_paramconverter')), array (  '_controller' => 'BC\\PlatformBundle\\Controller\\AdvertController::ParamConverterAction',));
        }
